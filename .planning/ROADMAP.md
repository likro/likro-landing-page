...
- [x] **Phase 6: Analytics Instrumentation Pass** — Verificação sistêmica de todos os eventos nos três dashboards (Pixel Test Events, GA4 DebugView, Clarity recordings), seção views, scroll-depth, PII masking validado em sessão real. (completed 2026-05-21)
...
Plans:
- [x] 04-00-PLAN.md — Foundation: useInView hook + glossary + 5 section scaffolds + page.tsx wiring + coherence test + copy-review.md Phase 4 cadence
- [x] 04-01-PLAN.md — Pain section (DARK, fragmentação operacional + constelação 4 pseudo-cards + statement-line)
- [x] 04-02-PLAN.md — Bridge section (LIGHT, statement editorial silencioso puro — D-15 reinterpretação NARR-02)
- [x] 04-03-PLAN.md — Product section (LIGHT off-white, 1 hero feature 'Atendimento multicanal' + 3 secundárias — D-16 reinterpretação NARR-03; NARR-08 implícito via iaLine D-20.1)
- [x] 04-04-PLAN.md — HowItWorks section (LIGHT neutral, 4 passos timeline vertical com mini-mockups)
- [x] 04-05-PLAN.md — Proof section (DARK editorial, categorias verticais minimal — zero Dolce Home per STATE.md 2026-05-18)
**UI hint**: yes
...
- [x] 05-03-PLAN.md — Edge route /api/lead + lead-resend + lead-sheets (JWT via jose, edge runtime)
...
Plans:
- [x] 06-01-PLAN.md — Wave 0 tests RED (use-section-view, scroll-depth-tracker, clarity-mask)
- [x] 06-02-PLAN.md — useSectionView hook + TrackSection wrapper + ScrollDepthTracker + data-clarity-mask no form
- [x] 06-03-PLAN.md — wiring em page.tsx (TrackSection x7 + ScrollDepthTracker) + TRACK-06 grep + VALIDATION.md final
- [x] 06-04-PLAN.md — 06-HUMAN-UAT.md (Parte B bloqueada) + checkpoint humano
